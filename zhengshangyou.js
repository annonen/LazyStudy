...
function zsyQuestion() {
    ...
    while (true) {
        ...
        } else if (className("ListView").exists() && !text("继续挑战").exists()) {
            zsyQuestionLoop();
        }
    }
}
 ...
 */
function SRQuestion() {
    if (className("android.view.View").text("邀请好友").exists()) {
...
function zsyQuestionLoop() {
    let ClickAnswer;
    while ((className("ListView").exists() && className("android.view.View").text("100").exists() && !text("继续挑战").exists()) || (className("ListView").exists() && className("android.view.View").text("").exists() && !text("继续挑战").exists())) {
        try {
