## 基于lolisaikou/LazyStudy修改。
   支持外置题库：在存储根目录新建tiku文件夹，将源码内的tiku.db文件复制到该文件夹内，则程序优先使用外置题库。
***
- 2021.05.15
        将争上游答题和双人对战添加进一键功能中：目前一键执行的操作有：听电台广播，每日答题，学习文章，包含点赞、分享和评论，本地频道，四人赛，双人对战，挑战答题。

- 2021.05.14
        关于订阅：恢复了订阅功能，但是并没有修复，会在所有任务结束后自动跳到订阅页面，请手动订阅。
        更新了题库。
...
[release下载](https://github.com/annonen/LazyStudy/releases/)  
## 关于本脚本
